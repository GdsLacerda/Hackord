...
def get_challenge_ctx(
    headless: typing.Optional[bool] = None, lang: typing.Optional[str] = None, proxy: typing.Optional[str] = None, **kwargs):
    # Control headless browser
    headless = True if headless is None or "linux" in sys.platform else headless
