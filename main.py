...
class gen:
    ...
    # Solver Solve
    def hit_challenge(self, driver, challenger: solver.HolyChallenger, retries: int = 10) -> typing.Optional[str]:
        ...
        for _ in range(retries):
            ...
            except solver.exceptions.ChallengePassed:
                return challenger.utils.get_hcaptcha_response(driver)
...
if __name__ == "__main__":
    try:
        ...
        gen(mailslurp_api_key).install_solver()
        while True:
            tools().clear()
            tools().logo()
            tools().machine()
